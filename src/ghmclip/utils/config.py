...
class TreeConfig:
    ...
    seed_tree: Optional[int] = field(default=42)
...
class DoubleTreeConfig:
    ...
    flip_scale: Optional[float] = field(default=1.0)
    translation_invariance: Optional[bool] = field(default=True)
    seed_itree: Optional[int] = field(default=24)
    seed_ttree: Optional[int] = field(default=42)
...
class ModelConfig:
    ...
    job: Optional[str] = field(default='cls')
...
class ClipModelConfig:
    ...
    clip_normalize: Optional[bool] = field(default=True)
    clip_temperature: Optional[float] = field(default=1.0)
