...
def main():
    ...
    for p in p_list:
        ...
        # text_tree.T_value[-1] = [res_text[0][:,idx].tolist() for idx in range(80)]
        for idx in range(80):
    ...
    with open("./figures/data/vlm-ood-pi20.json", "w") as f:
