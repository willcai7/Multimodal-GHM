...
def main():
    ...
    for p in p_list:
        ...
        text_tree.T_value[-1] = [t_leaves[:,idx].tolist() for idx in range(81)]
        image_tree.T_value[-1] = [i_leaves[:,idx].tolist() for idx in range(81)]
        # t_transtion = text_tree.transition
    ...
    with open("./figures/data/zsc-ood.json", "w") as f:
